      ...
      <section className="py-12 md:py-16 lg:py-20 px-4 bg-gradient-to-br from-yellow-50 via-amber-50 to-yellow-100">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 lg:gap-8 mb-8 md:mb-12">
            ...
            <div className="bg-white rounded-xl md:rounded-2xl p-4 md:p-6 shadow-lg border-2 border-gray-200 relative">
              ...
              <div className="mt-3 md:mt-4">
                <div className="text-2xl md:text-3xl font-bold text-gray-700 mb-2">$499</div>
                <p className="text-gray-600 text-xs md:text-sm mb-4 md:mb-6">5 características esenciales</p>
                ...
                <Button asChild variant="outline" className="w-full mt-4 md:mt-6 border-gray-300 text-sm md:text-base">
            ...
            <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-xl md:rounded-2xl p-4 md:p-6 shadow-lg border-2 border-purple-300 relative">
              ...
              <div className="mt-3 md:mt-4">
                <div className="text-2xl md:text-3xl font-bold text-purple-700 mb-2">$699</div>
                <p className="text-purple-600 text-xs md:text-sm mb-4 md:mb-6">8 características (+3 multimedia)</p>
                <div className="space-y-2 md:space-y-3 text-left">
                  {[
                    "Todo del Básico",
                    ...
                    <div key={index} className="flex items-center gap-2 text-xs md:text-sm">
                      ...
                      <span className={`min-w-0 ${feature.includes('✨') ? 'font-medium text-purple-700' : ''}`}>{feature}</span>
                    </div>
                  ))}
                </div>
                <Button asChild variant="outline" className="w-full mt-4 md:mt-6 border-purple-300 text-purple-700 text-sm md:text-base">
            ...
            <div className="bg-gradient-to-br from-yellow-100 to-amber-100 rounded-xl md:rounded-2xl p-4 md:p-6 shadow-2xl border-4 border-yellow-400 relative md:transform md:hover:scale-105 transition-transform md:col-span-2 lg:col-span-1">
              <div className="absolute -top-3 md:-top-4 left-1/2 -translate-x-1/2 bg-gradient-to-r from-yellow-400 to-amber-500 text-amber-900 px-4 md:px-6 py-2 rounded-full text-xs md:text-sm font-bold shadow-lg max-w-[calc(100%-2rem)]">
                <span className="hidden sm:inline">👑 VIP - EL MÁS EXCLUSIVO 👑</span>
                <span className="sm:hidden">👑 VIP 👑</span>
              </div>
              <div className="mt-4 md:mt-6">
                <div className="text-3xl md:text-4xl font-bold text-amber-800 mb-2">$899</div>
                <p className="text-amber-700 text-xs md:text-sm mb-4 md:mb-6 font-medium">11 características (+3 VIP exclusivas)</p>
                <div className="space-y-2 md:space-y-3 text-left">
                  {[
                    "Todo del Premium",
                    ...
                    <div key={index} className="flex items-center gap-2 text-xs md:text-sm">
                      ...
                      <span className={`min-w-0 ${
                        feature.includes('👑') ? 'font-bold text-amber-800' : 
                        feature.includes('⭐') ? 'font-semibold text-amber-700' : ''
                      }`}>{feature}</span>
                    </div>
                  ))}
                </div>
                ...
                >
                  <Link href={vipDemoData.demo.cta.link}>
                    <span className="hidden sm:inline">¡ESTÁS AQUÍ! - {vipDemoData.demo.cta.buttonText}</span>
                    <span className="sm:hidden">¡ESTÁS AQUÍ! - Contratar VIP</span>
                  </Link>
                </Button>
              </div>
            </div>
          ...
          <div className="bg-white rounded-2xl md:rounded-3xl p-4 md:p-6 lg:p-8 shadow-2xl border-2 border-yellow-200 mb-8 md:mb-12">
            ...
            <div className="grid md:grid-cols-3 gap-6 md:gap-8">
              <div className="text-center">
                ...
                <h4 className="font-semibold text-amber-800 mb-2 text-sm md:text-base">Logística Completa</h4>
                <p className="text-amber-600 text-xs md:text-sm leading-relaxed">Hospedaje, itinerario y pases digitales para una organización profesional total</p>
              </div>
              ...
              <div className="text-center">
                ...
                <h4 className="font-semibold text-amber-800 mb-2 text-sm md:text-base">Experiencia Premium</h4>
                <p className="text-amber-600 text-xs md:text-sm leading-relaxed">Playlist por momentos y galería categorizada para una experiencia superior</p>
              </div>
              ...
              <div className="text-center">
                ...
                <h4 className="font-semibold text-amber-800 mb-2 text-sm md:text-base">Estatus VIP</h4>
                <p className="text-amber-600 text-xs md:text-sm leading-relaxed">El paquete más exclusivo con todas las características más 3 únicas del VIP</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 md:gap-6 justify-center mb-6 md:mb-8 px-2">
            ...
            >
              <Link href={vipDemoData.demo.cta.link}>
                <span className="hidden sm:inline">{vipDemoData.demo.cta.buttonText}</span>
            ...
            >
              <Link href="/#plans">
                <span className="hidden sm:inline">Comparar todos los paquetes</span>
          ...
          <div className="bg-gradient-to-r from-yellow-100 to-amber-100 rounded-xl md:rounded-2xl p-4 md:p-6 border-2 border-yellow-300 max-w-3xl mx-auto">
            <div className="flex flex-col sm:flex-row items-center justify-center gap-2 md:gap-3 mb-3 md:mb-4 text-center">
              ...
              <h4 className="font-bold text-amber-800 text-base md:text-lg">Experiencia Demo VIP Completa</h4>
              <Crown className="w-5 md:w-6 h-5 md:h-6 text-yellow-600 fill-current" />
            </div>
            <p className="text-amber-700 leading-relaxed text-sm md:text-base">
              Acabas de experimentar la <strong>demostración más completa</strong> de nuestras invitaciones digitales. 
              El paquete VIP incluye <strong>logística integral del evento</strong> con hospedaje, itinerario detallado, 
              sistema de pases QR, playlist múltiple y galería categorizada. 
            </p>
            <div className="mt-3 md:mt-4 p-3 bg-white/60 rounded-lg">
              <p className="text-xs md:text-sm text-amber-600">
                <strong>💎 Demo interactivo:</strong> Todos los formularios y botones funcionan, 
                pero no envían datos reales. ¡Explora cada característica VIP!
              </p>
            </div>
          </div>
        </div>
