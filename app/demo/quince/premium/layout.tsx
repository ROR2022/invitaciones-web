...
export const metadata: Metadata = {
  title: 'Demo XV Años - Paquete Premium | Web Invitations',
  description: 'Demostración del paquete premium con música, galería y padrinos ($699) - ¡La más solicitada!',
  keywords: ['xv años', 'quinceañera', 'premium', 'música', 'galería', 'padrinos', 'invitación digital'],
}

export default function PremiumQuinceDemoLayout({
  children,
}: {
