...
export const metadata: Metadata = {
  title: 'Demo XV Años - Paquete Básico | Web Invitations',
  description: 'Demostración interactiva del paquete básico para invitaciones digitales de XV años ($499)',
  keywords: ['xv años', 'quinceañera', 'invitación digital', 'demo', 'paquete básico'],
}

export default function BasicQuinceDemoLayout({
  children,
}: {
