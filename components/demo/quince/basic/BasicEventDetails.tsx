      ...
      >
        ...
        <div className="grid md:grid-cols-4 gap-8 mt-12">
          ...
          <div className="flex flex-col items-center">
            ...
            <h3 className="text-xl font-medium mb-2">{basicDemoData.event.ceremony.type}</h3>
          ...
          <div className="flex flex-col items-center">
            <Clock className="w-12 h-12 text-primary mb-4" />
            <h3 className="text-xl font-medium mb-2">{basicDemoData.event.party.type}</h3>
          ...
          <div className="flex flex-col items-center">
            ...
            <p className="text-lg text-primary font-medium">{basicDemoData.event.dressCode}</p>
          </div>
        </div>
      </div>
    </section>
