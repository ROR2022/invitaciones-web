...
export const VipPetGallery = () => {
  ...
  // Obtener todas las imágenes de todas las categorías
  const allImages = (vipMascotaData.gallery || []).flatMap(category => 
  ...
  // Función para navegar por las imágenes en el lightbox
  const navigateImage = (direction: 'prev' | 'next') => {
    ...
    setZoomLevel(1) // Resetear zoom al cambiar imagen
    ...
    <section className="py-16 px-4 bg-gradient-to-br from-purple-50 to-pink-50">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          >
            Nuestros momentos más especiales capturados para siempre
          </motion.p>
        </div>
        ...
        <div className="mb-10">
          ...
          >
            ...
            {(vipMascotaData.gallery || []).map((category) => (
              <button 
                key={category.id}
