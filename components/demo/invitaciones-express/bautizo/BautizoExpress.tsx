...
import { dataBautizoExpress } from './dataBautizoExpress';

const BautizoExpress = () => {
  return (
    <div
      className="z-0 relative min-h-screen bg-cover bg-center bg-no-repeat flex items-center justify-center p-4"
      style={{
        backgroundImage: `url(${dataBautizoExpress.backgroundImage})`,
      }}
    >
      ...
      <div className="relative z-10 max-w-2xl mx-auto text-center text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20 hover:bg-white/15 transition-all duration-300 hover:scale-105 animate-slide-up-fade animation-delay-900">
            ...
            <p className="text-white font-medium">{dataBautizoExpress.date}</p>
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20 hover:bg-white/15 transition-all duration-300 hover:scale-105 animate-slide-up-fade animation-delay-1000">
            ...
            <p className="text-white font-medium">
              {dataBautizoExpress.guests} personas
            </p>
          </div>
          ...
          <div
            onClick={() =>
              window.open(dataBautizoExpress.ubiLinkCeremony, "_blank")
            }
          ...
          >
            ...
            <p className="text-white font-medium">
              {dataBautizoExpress.locationCeremony}
            </p>
            <div className="flex items-center gap-2 mt-1">
              <Clock className="w-4 h-4 text-blue-200" />
              <span className="text-blue-100 text-sm">
                {dataBautizoExpress.ceremonyTime}
              </span>
            </div>
          </div>
          ...
          <div
            onClick={() =>
              window.open(dataBautizoExpress.ubiLinkReception, "_blank")
            }
            style={{ cursor: "pointer" }}
          ...
          >
            ...
            <p className="text-white font-medium">
              {dataBautizoExpress.locationReception}
            </p>
            <div className="flex items-center gap-2 mt-1">
              <Clock className="w-4 h-4 text-green-200" />
              <span className="text-green-100 text-sm">
                {dataBautizoExpress.receptionTime}
              </span>
            </div>
          </div>
        </div>
