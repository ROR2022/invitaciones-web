...
const Confirmation = () => {
    ...
    const handleConfirm = () => {
        const confirmationNumber = dataCumpleExpress.confirmationNumber;
        // aqui se crea el mensaje
        const message = `¡Gracias por confirmar tu asistencia a la fiesta de cumpleaños de ${dataCumpleExpress.groom}!
        Detalles de la fiesta:
        Fecha: ${dataCumpleExpress.date}
        Hora: ${dataCumpleExpress.ceremonyTime}
        Ubicación: ${dataCumpleExpress.locationCeremony}`;
