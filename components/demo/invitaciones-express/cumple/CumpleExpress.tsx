...
const CumpleExpress = () => {
  return (
    <div
      ...
      style={{
        backgroundImage: `url(${dataCumpleExpress.backgroundImage})`,
      }}
    >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20 hover:bg-white/15 transition-all duration-300 hover:scale-105 animate-slide-up-fade animation-delay-1000">
            ...
            <p className="text-white font-medium">
              {dataCumpleExpress.guests} personas
            </p>
          </div>
          ...
          <div
            onClick={() =>
              window.open(dataCumpleExpress.ubiLinkCeremony, "_blank")
            }
          ...
          >
            ...
            <p className="text-white font-medium">
              {dataCumpleExpress.locationCeremony}
            </p>
            <div className="flex items-center gap-2 mt-1">
              <Clock className="w-4 h-4 text-blue-200" />
              <span className="text-blue-100 text-sm">
                {dataCumpleExpress.ceremonyTime}
              </span>
            </div>
          </div>
          ...
          <div
            onClick={() =>
              window.open(dataCumpleExpress.ubiLinkReception, "_blank")
            }
            style={{ cursor: "pointer" }}
